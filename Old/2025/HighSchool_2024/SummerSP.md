...
#### 変数の使用例
<img src="Image/SummerPs.md/hensu.png" height="450"><br>
...
#### 関数の使用例
<img src="Image/SummerPs.md/kansu.png" height="450"><br>
関数はこのように作成します。<br>
...
#### 条件分岐の使用例
ガード節
ゲームプログラムにおいて特定の状況では、実行しないプログラムが多々あります。<br>
例：プレイヤーが死んでいたら操作できない、ローディング中や演出中は操作できない。<br>
そういった際に大きなif分を作らず、先頭にif分を使ってreturnするようにしましょう。<br>
<img src="Image/SummerPs.md/gurd.png" height="450"><br>

#### その他プログラム例の紹介
GetCompornent<br>
GetCompornentを使うことで、同じオブジェクトにアタッチされているほかのコンポーネントの情報を取得することができます。<br>
この処理は重たい処理なのでUpdateでは使わないようにしましょう。基本はAwakeかStartの中で実施することで解決できます。<br>
<img src="Image/SummerPs.md/GetCompornent.png" height="450"><br><br><br>

レイによるあたり判定の実施<br>
レイとはゲーム内に見えない直線を引き、そこにオブジェクトが重なっているかを確認することができる機能です。<br>
プレイヤーの足元から数ミリ真下に線を引くことで、プレイヤーが着地しているか、どうかを判定するために使っています。<br>
<img src="Image/SummerPs.md/Ray.png" height="450"><br><br><br>

RequireComponent<br>
プログラムをアタッチした際に一緒に必要なスクリプトを設定することができます。<br>
この機能を使うことで、アタッチし忘れることがなくなるので、必ず使うようにしましょう。<br>
<img src="Image/SummerPs.md/Request.png" height="450"><br><br><br>

OnValidate<br>
この関数はシリアライズフィールドの変数の値が変更された際に呼び出されます。<br>
大量のオブジェクトを生成し間の調整を行う際などに便利です。<br>
今回はカメラの初期位置を調整できるようにしています。<br>
<img src="Image/SummerPs.md/Validate.png" height="450"><br><br><br>