...
<div style="display: flex; flex-wrap: wrap; gap: 1.5rem;">
    ...
    ">
      <img src="Image/Csharp.png" alt="C#画像" style="width: 100%; display: block;" />
      <div style="padding: 1rem;">
        <h3 style="margin-top: 0;">メモリと集合</h3>
        <p style="font-size: 0.9rem; color: #333; line-height: 1.5;">
          プログラムの根幹をなしているメモリの仕組みと、<br>
          それを活用するための集合について学びます。<br>
        </p>
        <a href="#/VocationalSchool_2024/PaizzaMemory.md" style="
          display: inline-block;
          background-color: #2b8be6;
          color: white;
          padding: 0.5rem 1rem;
    ...
    ">
      <img src="Image/Csharp.png" alt="C#画像" style="width: 100%; display: block;" />
      <div style="padding: 1rem;">
        <h3 style="margin-top: 0;">パイザでクラスを使おう</h3>
        <p style="font-size: 0.9rem; color: #333; line-height: 1.5;">
          皆さんのパイザのプログラムをみると、main()のみで書かれてる事が多いです。<br>
          パイザでも設計を意識してクラスを使って行きましょう。<br>
        </p>
        <a href="#/VocationalSchool_2024/PaizaClass.md" style="
          display: inline-block;
          background-color: #2b8be6;
          color: white;
          padding: 0.5rem 1rem;
    ...
    ">
      <img src="Image/Csharp.png" alt="C#画像" style="width: 100%; display: block;" />
      <div style="padding: 1rem;">
        <h3 style="margin-top: 0;">就活対策　SPI</h3>
        <p style="font-size: 0.9rem; color: #333; line-height: 1.5;">
          授業の趣旨とは少しズレますが、目標で合ったパイザのBランクを多くの人が取っているので、
          就活の本番に向けたSPI対策を行います。<br>
        </p>
        <a href="#/VocationalSchool_2024/SPI.md" style="
          display: inline-block;
          background-color: #2b8be6;
          color: white;
          padding: 0.5rem 1rem;
    ...
    ">
      <img src="Image/Csharp.png" alt="C#画像" style="width: 100%; display: block;" />
      <div style="padding: 1rem;">
        <h3 style="margin-top: 0;">パイザテスト　SPI</h3>
        <p style="font-size: 0.9rem; color: #333; line-height: 1.5;">
          パイザのテストを行います。<br>
        </p>
        <a href="#/VocationalSchool_2024/PaizaTest.md" style="
          display: inline-block;
          background-color: #2b8be6;
          color: white;
          padding: 0.5rem 1rem;
